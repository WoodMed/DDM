(function() {
    ...
    function onLeftMenuItemClick(s, e) {
        ...
        if (e.item.name === "WebDDM") {
            window.location.href = window.location.origin + '/DistributionMatrix.aspx'; // Navigate to Web DDM page
        }
        else if (e.item.name === "Logo") {
            window.location.href = window.location.origin + '/DistributionMatrix.aspx'; // Navigate to Homepage
        }
        else if(e.item.name === "ToggleLeftPanel")
            toggleLeftPanel();
        else if(e.item.name === "Back")
            window.history.back();
