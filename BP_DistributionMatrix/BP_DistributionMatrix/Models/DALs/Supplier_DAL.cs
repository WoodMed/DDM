...
public class Supplier_DAL
{
    ...
    public List<RelsDocsJoin_Model> GetAllRows(int userid, string company_id)
    {
        ...
        FROM  
            ddm.DocType_Supplier_Rels dtcr  -- Step 1: Filter doc types for the company  
        JOIN  
            ddm.DocTypes_Supplier t2  -- Step 2: Get document details  
        ...
        LEFT JOIN (  
            ...
            SELECT  
                ...
                STUFF((  
                    ...
                    FROM ddm.User_Rels_Supplier AS subInner  
            ...
            FROM ddm.User_Rels_Supplier sub  
        ...
        LEFT JOIN  
            ddm.User_Rels_Supplier t1  -- Step 5: Finally, get the user's action  
    ...
    public void SaveActions(List<UserRels_Model> rows)
    {
        using (SqlConnection connection = new SqlConnection(_connectionString))
        {
            ...
            {
                string query = @"MERGE INTO ddm.User_Rels_Supplier AS target
